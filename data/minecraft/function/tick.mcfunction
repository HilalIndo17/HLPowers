...
# = Performance =
execute as @e[type=arrow] at @s if entity @a[tag=power_owner,distance=250..] run kill @s
execute as @e[type=minecraft:snowball] at @s if entity @a[tag=power_owner,distance=200..] run kill @s
execute as @e[type=minecraft:wind_charge] at @s if entity @a[tag=power_owner,distance=250..] run kill @s
execute as @e[type=minecraft:wither_skull] at @s if entity @a[tag=power_owner,distance=250..] run kill @s
...
#SISTEM EXP MASIH OFF -> execute as @a[tag=power_owner] at @s if score @s exp_check matches 0..0 run title @s actionbar [{"text":"✨ ","color":"yellow"},{"text":"EXP","color":"green"},{"text":" » ","color":"gray"},{"text":"Level ","color":"red"},{"score":{"name":"@s","objective":"exp_check"},"color":"dark_red"},{"text":" (Not Enough EXP)","color":"red"}]
...
#execute at @e[type=minecraft:ender_pearl] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -1 points
execute as @a[tag=power_owner] at @e[type=minecraft:ender_pearl] run tp @p ~ ~ ~
execute as @a[tag=power_owner] at @e[type=minecraft:ender_pearl] run particle minecraft:flame
execute as @a[tag=power_owner] at @e[type=minecraft:ender_pearl] run summon tnt ~ ~ ~ {fuse:5,explosion_power:0.2,block_state:{Name:"minecraft:air"}}
execute as @a[tag=power_owner] at @e[type=minecraft:ender_pearl] run effect give @a[tag=power_owner,distance=..3] minecraft:resistance 1 11

#EndermiTnT (DONE WORK)
#execute at @e[type=minecraft:endermite] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -3 points
...
#execute at @e[type=minecraft:wind_charge] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -2 points
...
#Egg Fangs (DONE WORK)
#execute at @e[type=egg] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -1 points
...
#execute as @a[tag=power_owner] at @s if items entity @s weapon.offhand minecraft:orange_wool at @s run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -1 points
...
#execute as @a[tag=power_owner] at @s if items entity @s weapon.mainhand minecraft:orange_wool at @s run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -1 points
...
#execute at @e[type=minecraft:eye_of_ender] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s 0 points
...
#execute at @e[type=minecraft:snowball] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -1 points
...
#execute at @e[type=minecraft:firework_rocket] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s 0 points
...
#execute at @e[type=minecraft:splash_potion,tag=splash_boom] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -4 points
...
#execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s 0 points
execute as @a[tag=power_owner] at @s run tag @e[type=minecraft:splash_potion,distance=..2] add splash_boom

#Lingerboom (DONE WORK)
#execute at @e[type=minecraft:lingering_potion] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -1 points
...
#execute at @e[type=minecraft:copper_golem] positioned ~ ~ ~ run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -35 points
execute at @e[type=minecraft:copper_golem] positioned ~ ~ ~ run playsound minecraft:item.goat_horn.sound.5 player @a[distance=..70] ~ ~ ~ 2.6 1
execute at @e[type=minecraft:copper_golem] run execute at @a[tag=power_owner,limit=1,sort=nearest] run execute at @e[tag=!power_owner,distance=..100] run summon tnt ~ ~ ~ {fuse:110,explosion_power:1.5}
execute at @e[type=minecraft:copper_golem] run kill @e[type=minecraft:copper_golem]

#Singularity of TNT (DONE WORK)
#execute at @e[type=minecraft:snow_golem] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -3 points
...
#Crossboom (DONE WORK)
#execute as @a[tag=power_owner] at @s if items entity @s weapon.mainhand minecraft:crossbow at @s run execute at @e[type=arrow,tag=arrow_boom] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -1 points
execute at @e[tag=arrow_boom,nbt={inGround:1b}] run summon tnt ~ ~ ~ {fuse:1,explosion_power:1.5}
execute as @e[tag=arrow_boom,nbt={inGround:1b}] at @s run kill @s

#execute as @a[tag=power_owner] at @s if items entity @s weapon.mainhand minecraft:crossbow at @s run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s 0 points
...
execute at @e[tag=arrow_boom] run damage @e[tag=!power_owner,type=!minecraft:trident,distance=..3,limit=1] 5 minecraft:player_attack by @p[tag=power_owner]
execute at @e[tag=arrow_boom] run particle minecraft:soul_fire_flame ~ ~ ~ 0.1 0.1 0.1 0.1 10

#Rodhook (V2 FORM) (DONE WORK)
#execute at @e[tag=hook] unless block ~ ~-0.5 ~ air at @a[tag=power_owner] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -1 points
...
#Endermage (DONE WORK)
#execute as @a[tag=power_owner] at @s if items entity @s weapon.offhand minecraft:chorus_fruit at @s run execute as @e[tag=power_owner,nbt={HurtTime:10s}] at @s run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -30 points
...
#execute as @a[tag=power_owner] at @s if items entity @s weapon.mainhand minecraft:string at @s run execute as @a[tag=power_owner] at @s positioned ~ ~0.5 ~ unless block ^ ^ ^0.5 air run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -1 points
...
#execute as @a[tag=power_owner] at @s if items entity @s weapon.* minecraft:fishing_rod[!minecraft:custom_name="Rodhook"] at @s run execute as @e[type=minecraft:fishing_bobber] at @s run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -3 points
execute as @a[tag=power_owner] at @s if items entity @s weapon.* minecraft:fishing_rod[!minecraft:custom_name="Rodhook"] at @s run execute at @e[type=minecraft:fishing_bobber] run summon tnt ~ ~ ~ {fuse:1,explosion_power:1.5}
execute as @a[tag=power_owner] at @s if items entity @s weapon.* minecraft:fishing_rod[!minecraft:custom_name="Rodhook"] at @s run execute at @e[type=minecraft:fishing_bobber] run particle minecraft:flame
execute as @a[tag=power_owner] at @s if items entity @s weapon.* minecraft:fishing_rod[!minecraft:custom_name="Rodhook"] at @s run execute at @e[type=minecraft:fishing_bobber] run particle minecraft:wax_on
execute as @a[tag=power_owner] at @s if items entity @s weapon.* minecraft:fishing_rod[!minecraft:custom_name="Rodhook"] at @s run execute at @e[type=minecraft:fishing_bobber] run effect give @p[tag=power_owner] minecraft:jump_boost 1 0
execute as @a[tag=power_owner] at @s if items entity @s weapon.* minecraft:fishing_rod[!minecraft:custom_name="Rodhook"] at @s run execute at @e[type=minecraft:fishing_bobber] run effect give @p[tag=power_owner] minecraft:resistance 1 1

#Sluggish Domain (DONE WORK)
#execute at @e[type=minecraft:strider,tag=target] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -200 points
...
#execute as @a[tag=power_owner] at @s if items entity @s weapon.offhand minecraft:shield at @s run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -1 points
...
#execute as @a[tag=power_owner] at @s if items entity @s weapon.mainhand minecraft:heart_of_the_sea at @s positioned ^ ^0.5 ^1 run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -1 points
...
#execute as @a[tag=power_owner] at @s if items entity @s weapon.offhand minecraft:heart_of_the_sea at @s run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -2 points
...
#Death Orb (DONE WORK)
#execute at @e[type=minecraft:creaking,tag=target] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -200 points
...
#execute as @e[type=item,name="Echo Shard"] unless entity @e[tag=echo] at @a[tag=power_owner] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -47 points
#execute at @e[type=item,name="Echo Shard"] unless entity @e[tag=echo] at HilalIndo17 run particle minecraft:soul_fire_flame ~ ~0.5 ~ 0.5 0.5 0.5 0.1 200
...
execute at @e[tag=echo] run tp @e[tag=echo] ^ ^ ^-3
...
#execute as @e[type=item,name="Fire Charge"] at @a[tag=power_owner] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -38 points
...
#Bomb Core (DONE WORK)
#execute as @e[type=item,name="Creeper Head"] at @a[tag=power_owner] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -35 points
...
execute as @e[type=item,name="Creeper Head"] run execute at @p at @s run execute at @s positioned ~ ~1 ~ run summon minecraft:tnt ~ ~ ~ {explosion_power:2.6,fuse:30,Tags:["creeper_tnt"],block_state:{Name:"minecraft:air"}}
...
execute at @e[type=item,name="Creeper Head"] run effect give @p[tag=power_owner] minecraft:absorption 2 5
...
#execute as @a[tag=power_owner] at @s if items entity @s weapon.mainhand minecraft:nether_star at @s run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -2 points
...
#execute at @e[type=minecraft:trident,tag=stormbringer] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -3 points
...
#Voidseer (DONE WORK)
#execute as @a[tag=power_owner] at @s if items entity @s weapon.mainhand minecraft:blaze_rod at @s positioned ^ ^0.5 ^10 run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -2 points
...
#execute as @a[tag=power_owner] at @s if items entity @s weapon.offhand minecraft:blaze_rod at @s positioned ^ ^0.5 ^10 run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -1 points
...
#execute as @a[tag=power_owner] at @s if items entity @s weapon.mainhand minecraft:poppy at @s run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -3 points
...
#execute as @a[tag=power_owner] at @s if items entity @s weapon.offhand minecraft:poppy at @s run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -2 points
...
#execute as @e[type=item,name="Redstone Dust"] unless entity @e[tag=beam] at @a[tag=power_owner] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -114 points
#execute as @e[type=item,name="Redstone Dust"] unless entity @e[tag=beam] at HilalIndo17 run particle minecraft:explosion ~ ~0.5 ~ 1 1 1 0.1 15
...
execute at @e[tag=beam] run tp @e[tag=beam] ^ ^ ^-5
...
#execute at @e[type=minecraft:mule] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -600 points
...
#execute at @e[type=minecraft:shulker,tag=target] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -700 points
...
#Hellfire (DONE WORK)
#execute as @e[type=item,name="Flint and Steel"] unless entity @e[tag=flame_shot] at @a[tag=power_owner] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -300 points
...
# = TIER 5 =
#Awakening (DONE WORK)
#execute at @e[type=minecraft:zombie_horse,tag=target] run execute as @a[tag=power_owner] at @s if score @s exp_check matches 1..999999999 run experience add @s -1000 points
...
# NOTE: 
#  -(DONE EXP) berarti kondisi exp sudah benar dan dicek
#  -(DONE WORK) berarti kekuatan sudah bekerja dan di tes
#  -(DONE 2PPL) berarti kekuatan sudah bekerja dengan 2 player/lebih

# TODO: Mengecualikan semua block2 tembus di kekuatan Spiclimber
# FIXME: -